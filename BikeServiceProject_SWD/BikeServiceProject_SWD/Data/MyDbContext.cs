...
namespace BikeServiceProject_SWD.Data
{
    public partial class MyDbContext : DbContext
    {
        ...
        public virtual DbSet<ModelType> ModelTypes { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>(entity =>
            {
                ...
                entity.HasIndex(e => e.StoreId, "fk_store_id_idx");
            ...
            modelBuilder.Entity<Ward>(entity =>
            {
                ...
                entity.HasIndex(e => e.DistrictId, "fk_district_id_idx");
